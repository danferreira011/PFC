<?php
	...
	{	
		...
		var		$cpf;
		var		$rg;
			function __construct($cod_cli,$status,$rua,$numero,$bairro,$cidade,$estado,$cep,$pais,$tel,$cel,$email,$tipocliente,$nome,$sobrenome,$cpf,$rg)
			{
			...
			function IncluirPF()
			{
				...
				$sql.="('$this->cod_cli','$this->tipocliente','$this->nome','$this->sobrenome','$this->cpf','$this->rg','$this->tel','$this->cel','$this->email','$this->status')";				
				$controle->setSQL($sql);
				$controle->ExecutarSQL();
